...
namespace ReverseProxyApplication
{
  public class ReverseProxyMiddleware
  {
    ...
    public async Task Invoke(HttpContext context)
    {
      ...
      if (targetUri != null)
      {
        ...
        using (var responseMessage =
          await _httpClient.SendAsync(targetRequestMessage,
    ...
    private async Task ProcessResponseContent(HttpContext context,
      HttpResponseMessage responseMessage)
    {
        ...
        IsContentOfType(responseMessage, "text/javascript"))
      {
        ...
        var newContent = stringContent.Replace("https://www.google.com",
          "/google")
    ...
    private bool IsContentOfType(HttpResponseMessage responseMessage,
      string type)
    {
      var result = false;
    ...
    private void CopyFromTargetResponseHeaders(HttpContext context,
      HttpResponseMessage responseMessage)
    {
